...
# sshpass -p 'xiaoding' scp ./build/Release/h264.node  eric@192.168.137.25:/home/eric/picam/build/Release
sshpass -p 'xiaoding' scp -r ./src  eric@192.168.137.25:/home/eric/picam
sshpass -p 'xiaoding' scp -r ./example  eric@192.168.137.25:/home/eric/picam
