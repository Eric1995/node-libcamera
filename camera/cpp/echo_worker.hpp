...
class EchoWorker : public AsyncProgressQueueWorker<WorkerType>
{
  public:
    EchoWorker(const Napi::CallbackInfo &info, libcamera::Camera *_camera, std::deque<libcamera::Request *> *wait_queue, std::map<libcamera::Stream *, Stream *> *_stream_map,
